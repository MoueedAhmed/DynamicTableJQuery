...
$(document).ready(function () {
    $("#add-row").click(function () {
        addRow('tablemain', "<tr>" + "<td><input type='checkbox' name='chk'/></td>" + "<td><input type=text class=sno></input></td>" + "<td><input type=text class=pname></input></td>" + "</tr>")
    });
